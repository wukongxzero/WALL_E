"""Verify WallENavigationEnvCfg actually constructs, resets, and steps.

Mirrors test_asro_navigation.py.
...
parser = argparse.ArgumentParser(description="Verify WallENavigationEnvCfg.")
...
from wall_e_navigation_env_cfg import WallENavigationEnvCfg


def main():
    cfg = WallENavigationEnvCfg()
    ...
    for step in range(30):
        ...
        obs, rew, terminated, _truncated, _info = env.step(actions)
        if step % 10 == 0:
